...
function printMarkdownInventory(root, skillList) {
  process.stdout.write(`Found ${skillList.length} local skills under ${path.join(root, ".agents", "skills")}.\n\n`);
...
function printUsage() {
  process.stdout.write(`Usage: node inventory-local-skills.mjs [--repo <path>] [--markdown|--json] [--check-agents] [--agents <path>]\n`);
}
